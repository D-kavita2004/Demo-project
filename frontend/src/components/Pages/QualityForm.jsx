                  ...
                  {/* ====================== DEFECTIVENESS DETAIL ====================== */}
                        <section className="space-y-6 border-4 shadow-sm shadow-gray-700 px-3 rounded-2xl bg-gray-200">
                          <AccordionItem value="item-2" className="w-full">
                              <AccordionTrigger><h2 className="text-2xl font-semibold border-b pb-2">Defectiveness Detail</h2></AccordionTrigger>
                              <AccordionContent className="w-full">
                                  <PermissionedSection sectionKey="defectivenessDetail" isNewForm={isNewForm} formStatus={clickedForm?.status} >
                                        <div className="w-full grid md:grid-cols-2 gap-6 p-4 rounded-lg border bg-card text-card-foreground shadow-sm border-blue-500">
                  ...
                  {/* ====================== QUALITY CHECK COMMENT ====================== */}
                        <section className="space-y-6 border-4 shadow-sm shadow-gray-700 px-3 rounded-2xl bg-gray-200">
                          <AccordionItem value="item-3" className="w-full">
                            <AccordionTrigger> <h2 className="text-2xl font-semibold border-b pb-2">Quality Check Comment</h2></AccordionTrigger>
                            <AccordionContent className="w-full">
                                <PermissionedSection sectionKey="qualityCheckComment" isNewForm={isNewForm} formStatus={clickedForm?.status} >
                  ...
                  {/* ====================== MEASURES REPORT ====================== */}
                        <section className="space-y-6 border-4 shadow-sm shadow-gray-700 px-3 rounded-2xl bg-gray-200">
                          <AccordionItem value="item-4" className="w-full">
                              <AccordionTrigger><h2 className="text-2xl font-semibold border-b pb-2">Measures Report</h2></AccordionTrigger>
                              <AccordionContent className="w-full">
                  ...
                  {/* ====================== Results of Measures Enforcement ====================== */}
                        ...
                        <section className="space-y-6 border-4 shadow-sm shadow-gray-700 px-3 rounded-2xl bg-gray-200">
                          <AccordionItem value="item-5" className="w-full">
                              <AccordionTrigger> <h2 className="text-2xl font-semibold border-b pb-2">Results of Measures Enforcement</h2></AccordionTrigger>
                              <AccordionContent className="w-full">
                                <PermissionedSection sectionKey="resultsOfMeasuresEnforcement" isNewForm={isNewForm} formStatus={clickedForm?.status} >  
                                  <div className="grid gap-4w-full grid md:grid-cols-2 gap-6 p-4 rounded-lg border bg-card text-card-foreground shadow-sm border-blue-500">
                  ...
                  {/* ====================== Results of Measures Effect====================== */}
                      ...
                      <section className="space-y-6 border-4 shadow-sm shadow-gray-700 px-3 rounded-2xl bg-gray-200">
                        <AccordionItem value="item-6" className="w-full">
                          ...
                          <AccordionContent className="w-full">
                            <PermissionedSection sectionKey="resultsOfMeasuresEffect" isNewForm={isNewForm} formStatus={clickedForm?.status} >
                              <div className="w-full grid md:grid-cols-2 gap-6 p-4 rounded-lg border bg-card text-card-foreground shadow-sm border-blue-500">
