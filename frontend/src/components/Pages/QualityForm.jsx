      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <CardContent className="flex flex-col gap-10 my-6">
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 p-4 rounded-lg border bg-card text-card-foreground shadow-sm">
          ...
          <section className="space-y-6">
                ...
                <div className="grid gap-4 p-4 rounded-lg border bg-card text-card-foreground shadow-sm col-span-2">
